      ...
      <div class="row m-0">
        <div class="col-12 p-0">    
          <div class="login-card">
            <div>
              <div><a class="logo" href=""><img class="img-fluid for-light" src="{{asset('public/assets/images/logo/login.png')}}" style="width:150px;height:80px;" alt="looginpage">
         </a></div>
   ...
   @endif
                <form class="theme-form" action="loginaction" method="post">
                  ...
                  <div class="form-group mb-0">
                    ...
                    </div><a class="link" href="{{ url('/admin/forget') }}">Forgot password?</a>
